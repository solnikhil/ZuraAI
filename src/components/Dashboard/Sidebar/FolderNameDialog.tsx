...
import { Brain, Check, FolderOpen } from '../../icons'
      ...
      <DialogContent className="folder-name-dialog">
        ...
        {mode === 'create' ? (
          <div className="folder-name-dialog__onboarding">
            <div className="folder-name-dialog__hint">
              <FolderOpen size={16} />
              <span>Folders keep chats and folder-scoped memories in one workspace.</span>
            </div>
            <div className="folder-name-dialog__memory-panel" aria-label="Memory mode">
              <div className="folder-name-dialog__memory-header">
                ...
                <div>
                  ...
                  <span>This setting cannot be changed later.</span>
                </div>
              </div>
              <button
                type="button"
