 ...
 *
 * Feature: sidebar-redesign, Property 2: Keyboard navigation focus index stays in bounds
...
// ============================================================================
// Property 2: Keyboard navigation focus index stays in bounds
// ============================================================================
...
describe('Property 2: Keyboard navigation focus index stays in bounds', () => {
    ...
    it('empty list always returns -1', () => {
        fc.assert(
            fc.property(
                fc.constantFrom('ArrowDown' as KeyAction, 'ArrowUp' as KeyAction),
                (action) => {
