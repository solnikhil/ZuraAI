 ...
 *
 * Feature: sidebar-redesign, Property 1: Search filtering returns only matching sessions
...
const nonWhitespaceQueryArb = fc.string({ minLength: 1, maxLength: 50 }).filter(s => s.trim().length > 0)

// ============================================================================
// Property 1: Search filtering returns only matching sessions
// ============================================================================
