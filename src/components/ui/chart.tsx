...
interface ChartTooltipContentProps extends Omit<React.HTMLAttributes<HTMLDivElement>, 'content'> {
  ...
  nameKey?: string
  labelKey?: string
  labelFormatter?: (label: string, payload: Array<{ payload?: Record<string, unknown> }>) => React.ReactNode
  formatter?: (
    value: number | string,
    name: string,
    item: { dataKey?: string | number; value?: number | string; color?: string; payload?: Record<string, unknown> },
    index: number,
    payload: Record<string, unknown>
  ) => React.ReactNode
  color?: string
