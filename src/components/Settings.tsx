...
export default function Settings() {
    ...
    // customModels are now part of settings/pendingSettings
    ...
    // Sync pending settings when global settings change (e.g. initial load)
    React.useEffect(() => {
    ...
    const deleteModel = (index: number) => {
        ...
        const updatedModels = pendingSettings.configuredModels.filter((_: { code: string; displayName: string }, i: number) => i !== index)
        // If deleting the active model, switch to first available or default
                    ...
                    <div className="settings-section">
                        ...
                        <div className="setting-group danger-zone">
                            ...
                            <div className="setting-item">
                                ...
                                <button onClick={resetSettings} className="danger-btn">
                                    Reset to Defaults
                                </button>
                            </div>
                        </div>
                            ...
                            <div className="setting-item">
                                ...
                                <div style={{ display: 'flex', gap: '10px', alignItems: 'center' }}>
                                    <select
                                        ...
                                        style={{ flex: 1 }}
                                    >
                                        {(pendingSettings.configuredModels || []).map((model: { code: string; displayName: string }) => (
