...
describe('SkillsSection', () => {
  it('renders skills list row with actions', () => {
    ...
    expect(screen.getByText('Tavily Web Search Skill')).toBeInTheDocument()
    expect(screen.getByText('Active')).toBeInTheDocument()
    expect(screen.getByRole('button', { name: /more actions for tavily web search skill/i })).toBeInTheDocument()
  })
  ...
  it('toggles disable from 3-dot actions menu', () => {
    ...
    const moreActions = screen.getByRole('button', { name: /more actions for tavily web search skill/i })
