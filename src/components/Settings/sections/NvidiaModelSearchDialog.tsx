...
export function NvidiaModelSearchDialog({
  ...
  const filteredModels = useMemo(() => {
    ...
    return searchNvidiaModels(models, searchQuery)
  }, [models, searchQuery])

  const handleAddModel = (apiModel: NvidiaModel) => {
    onAddModel(mapNvidiaModelToConfiguredModel(apiModel))
    onOpenChange(false)
    setSearchQuery('')
  }
        ...
        <DialogHeader className="border-b border-border px-6 py-4">
          <div className="flex items-start justify-between gap-3">
            <div className="min-w-0">
              <DialogTitle>Add Model from NVIDIA NIM Catalog</DialogTitle>
              <DialogDescription>
                Browse NVIDIA NIM chat models from the OpenAI-compatible catalog.
              </DialogDescription>
            </div>
            <Button
              variant="outline"
        ...
        <div className="px-6 py-4 border-b border-border">
          <div className="relative">
            ...
            <Input
              ...
              placeholder="Search NVIDIA models by name or ID..."
              ...
              {filteredModels.length === 0 ? (
                ...
                <div className="space-y-2">
                  {filteredModels.map((model) => {
                    const configuredModel = mapNvidiaModelToConfiguredModel(model)
