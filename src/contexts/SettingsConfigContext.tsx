...
export const defaultSettingsConfig: SettingsConfig = {
  ...
  alibabaModels: [
    // === Commercial (enabled) ===
    { code: 'qwen3-max', displayName: 'Qwen3 Max', enabled: true, maxContext: 262144, supportsDeepThinking: true },
    {
    ...
    { code: 'qwen3.5-plus', displayName: 'Qwen3.5 Plus', enabled: true, maxContext: 1000000, supportsDeepThinking: true },
    {
      code: 'qwen3.5-flash',
    ...
    { code: 'qwq-plus', displayName: 'QwQ Plus', enabled: true, maxContext: 128000, supportsDeepThinking: true },
    ...
    { code: 'qwen3.5-397b-a17b', displayName: 'Qwen3.5 397B', enabled: true, maxContext: 131072, supportsDeepThinking: true },
    { code: 'qwen3.5-122b-a10b', displayName: 'Qwen3.5 122B', enabled: true, maxContext: 262144, supportsDeepThinking: true },
    { code: 'qwen3.5-27b', displayName: 'Qwen3.5 27B', enabled: true, maxContext: 262144, supportsDeepThinking: true },
    { code: 'qwen3.5-35b-a3b', displayName: 'Qwen3.5 35B A3B', enabled: true, maxContext: 262144, supportsDeepThinking: true },
    // === Open source (enabled) ===
    { code: 'qwen3-235b-a22b', displayName: 'Qwen3 235B', enabled: true, maxContext: 131072, supportsDeepThinking: true },
    { code: 'qwen3-32b', displayName: 'Qwen3 32B', enabled: true, maxContext: 32768, supportsDeepThinking: true },
    { code: 'qwen3-30b-a3b', displayName: 'Qwen3 30B', enabled: true, maxContext: 32768, supportsDeepThinking: true },
    { code: 'qwen3-14b', displayName: 'Qwen3 14B', enabled: true, maxContext: 32768, supportsDeepThinking: true },
    { code: 'qwen3-8b', displayName: 'Qwen3 8B', enabled: true, maxContext: 32768, supportsDeepThinking: true },
    ...
    { code: 'qwen3-4b', displayName: 'Qwen3 4B', enabled: false, maxContext: 8192, supportsDeepThinking: true },
    { code: 'qwen3-1.7b', displayName: 'Qwen3 1.7B', enabled: false, maxContext: 4096, supportsDeepThinking: true },
    { code: 'qwen3-0.6b', displayName: 'Qwen3 0.6B', enabled: false, maxContext: 4096, supportsDeepThinking: true },
