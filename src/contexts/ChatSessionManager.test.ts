...
describe('ChatSessionManager', () => {
    ...
    describe('Initialization', () => {
         ...
         * WHEN the application starts, THE ChatHistoryContext SHALL load only 
    ...
    describe('On-Demand Loading', () => {
         ...
         * WHEN a chat session is selected, THE ChatHistoryContext SHALL load 
    ...
    describe('Maximum Loaded Sessions', () => {
         ...
         * THE ChatHistoryContext SHALL maintain a maximum of 3 fully-loaded 
    ...
    describe('Inactive Session Unloading', () => {
         ...
         * SHALL unload its full message content from memory
         */
