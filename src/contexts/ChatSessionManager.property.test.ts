...
const uniqueSessionsArbitrary = (minLength: number, maxLength: number) =>
    fc.array(chatSessionArbitrary, { minLength, maxLength })
        .map(sessions => {
            // Ensure unique IDs
...
describe('ChatSessionManager Memory Optimization Property Tests', () => {
    ...
    /**
     * Feature: electron-performance-optimization, Property 15: Metadata-Only Initial Load
     * 
     * *For any* application startup, the initial chat history load SHALL contain only
    ...
    /**
     * Feature: electron-performance-optimization, Property 16: On-Demand Session Loading
     * 
     * *For any* chat session, its full message content SHALL only be loaded after
    ...
    /**
     * Feature: electron-performance-optimization, Property 18: Inactive Session Unloading
     * 
     * *For any* chat session that has not been active for 5 minutes, its full message
     * content SHALL be unloaded from memory.
     * 
    ...
    /**
     * Feature: electron-performance-optimization, Property 19: Maximum Loaded Sessions
     * 
