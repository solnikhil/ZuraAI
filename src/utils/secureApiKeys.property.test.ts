...
describe('Secure API Keys Property Tests', () => {
    ...
    /**
     * Feature: minimax-provider, Property 8: Secure Storage Round-Trip
     * 
     * *For any* MiniMax API key stored via secure storage, retrieving it SHALL return the identical value.
     * 
    ...
    describe('Property 8: Secure Storage Round-Trip', () => {
        ...
        const apiKeyNameArb = fc.constantFrom(
            ...
            'tavilyApiKey',
            'alibabaApiKey'
        ) as fc.Arbitrary<'openRouterApiKey' | 'perplexityApiKey' | 'groqApiKey' | 'tavilyApiKey' | 'alibabaApiKey'>
