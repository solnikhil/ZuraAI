...
export const ArrowLeft = withDefaultWeight(ArrowLeftBase, 'regular', 'ArrowLeft')
export const BarChart = withDefaultWeight(ChartBarBase, 'duotone', 'BarChart')
export const Bell = withDefaultWeight(BellSimpleBase, 'regular', 'Bell')
export const Box = withDefaultWeight(CubeBase, 'duotone', 'Box')
export const Brain = withDefaultWeight(BrainBase, 'duotone', 'Brain')
export const Cable = withDefaultWeight(PlugsConnectedBase, 'regular', 'Cable')
...
export const Check = withDefaultWeight(CheckBase, 'regular', 'Check')
...
export const CheckSquare = withDefaultWeight(CheckSquareBase, 'regular', 'CheckSquare')
export const ChevronDown = withDefaultWeight(CaretDownBase, 'regular', 'ChevronDown')
export const ChevronLeft = withDefaultWeight(CaretLeftBase, 'regular', 'ChevronLeft')
export const ChevronRight = withDefaultWeight(CaretRightBase, 'regular', 'ChevronRight')
export const ChevronRightIcon = ChevronRight
export const ChevronUp = withDefaultWeight(CaretUpBase, 'regular', 'ChevronUp')
...
export const CircleIcon = withDefaultWeight(CircleBase, 'regular', 'CircleIcon')
export const Clipboard = withDefaultWeight(ClipboardBase, 'regular', 'Clipboard')
export const Clock = withDefaultWeight(ClockBase, 'duotone', 'Clock')
export const Cloud = withDefaultWeight(CloudBase, 'duotone', 'Cloud')
export const Code = withDefaultWeight(CodeBase, 'regular', 'Code')
export const Code2 = withDefaultWeight(CodeBlockBase, 'regular', 'Code2')
export const Command = withDefaultWeight(CommandBase, 'regular', 'Command')
export const Copy = withDefaultWeight(CopyBase, 'regular', 'Copy')
export const CornerDownLeft = withDefaultWeight(ArrowBendDownLeftBase, 'regular', 'CornerDownLeft')
export const Cpu = withDefaultWeight(CpuBase, 'regular', 'Cpu')
export const Database = withDefaultWeight(DatabaseBase, 'regular', 'Database')
export const Download = withDefaultWeight(DownloadBase, 'regular', 'Download')
export const Edit2 = withDefaultWeight(NotePencilBase, 'regular', 'Edit2')
export const Ellipsis = withDefaultWeight(DotsThreeBase, 'regular', 'Ellipsis')
export const ExternalLink = withDefaultWeight(ArrowSquareOutBase, 'regular', 'ExternalLink')
export const Eye = withDefaultWeight(EyeBase, 'regular', 'Eye')
export const EyeOff = withDefaultWeight(EyeSlashBase, 'regular', 'EyeOff')
export const File = withDefaultWeight(FileBase, 'regular', 'File')
export const FileArchive = withDefaultWeight(FileArchiveBase, 'regular', 'FileArchive')
export const FileAudio = withDefaultWeight(FileAudioBase, 'regular', 'FileAudio')
export const FileCode2 = withDefaultWeight(FileCodeBase, 'regular', 'FileCode2')
export const FileCog = withDefaultWeight(FileMagnifyingGlassBase, 'regular', 'FileCog')
export const FileDown = withDefaultWeight(FileArrowDownBase, 'regular', 'FileDown')
export const FileEdit = withDefaultWeight(NotePencilBase, 'regular', 'FileEdit')
export const FileImage = withDefaultWeight(FileImageBase, 'regular', 'FileImage')
export const FileJson = withDefaultWeight(FileCodeBase, 'regular', 'FileJson')
export const FileKey = withDefaultWeight(FileMagnifyingGlassBase, 'regular', 'FileKey')
export const FileSpreadsheet = withDefaultWeight(FileXlsBase, 'regular', 'FileSpreadsheet')
export const FileTerminal = withDefaultWeight(CodeBlockBase, 'regular', 'FileTerminal')
export const FileText = withDefaultWeight(FileTextBase, 'regular', 'FileText')
export const FileType = withDefaultWeight(FileTextBase, 'regular', 'FileType')
export const FileVideo = withDefaultWeight(FileVideoBase, 'regular', 'FileVideo')
export const FlaskConical = withDefaultWeight(FlaskBase, 'duotone', 'FlaskConical')
export const Folder = withDefaultWeight(FolderBase, 'regular', 'Folder')
export const FolderOpen = withDefaultWeight(FolderOpenBase, 'regular', 'FolderOpen')
export const Ghost = withDefaultWeight(GhostBase, 'duotone', 'Ghost')
export const Globe = withDefaultWeight(GlobeBase, 'duotone', 'Globe')
export const HardDrive = withDefaultWeight(HardDriveBase, 'regular', 'HardDrive')
export const Home = withDefaultWeight(HouseBase, 'regular', 'Home')
...
export const KeyRound = withDefaultWeight(KeyBase, 'regular', 'KeyRound')
export const LayoutDashboard = withDefaultWeight(LayoutBase, 'duotone', 'LayoutDashboard')
export const Link2 = withDefaultWeight(LinkBase, 'regular', 'Link2')
export const Loader2 = withDefaultWeight(SpinnerGapBase, 'regular', 'Loader2')
export const Loader2Icon = Loader2
export const LoaderCircle = withDefaultWeight(CircleNotchBase, 'regular', 'LoaderCircle')
export const Lock = withDefaultWeight(LockBase, 'regular', 'Lock')
export const Maximize2 = withDefaultWeight(CornersOutBase, 'regular', 'Maximize2')
...
export const MoreHorizontal = withDefaultWeight(DotsThreeBase, 'regular', 'MoreHorizontal')
export const MoreVertical = withDefaultWeight(DotsThreeVerticalBase, 'regular', 'MoreVertical')
export const OctagonXIcon = withDefaultWeight(XCircleBase, 'duotone', 'OctagonXIcon')
export const Paintbrush = withDefaultWeight(PaintBrushBase, 'regular', 'Paintbrush')
export const PanelLeft = withDefaultWeight(SidebarSimpleBase, 'regular', 'PanelLeft')
export const Paperclip = withDefaultWeight(PaperclipBase, 'regular', 'Paperclip')
export const PencilLine = withDefaultWeight(PencilLineBase, 'regular', 'PencilLine')
export const Pin = withDefaultWeight(PushPinBase, 'regular', 'Pin')
export const Play = withDefaultWeight(PlayBase, 'fill', 'Play')
export const Plus = withDefaultWeight(PlusBase, 'regular', 'Plus')
export const RefreshCcw = withDefaultWeight(ArrowClockwiseBase, 'regular', 'RefreshCcw')
export const RotateCcw = withDefaultWeight(ArrowCounterClockwiseBase, 'regular', 'RotateCcw')
export const RotateCw = withDefaultWeight(ArrowClockwiseBase, 'regular', 'RotateCw')
export const Scissors = withDefaultWeight(ScissorsBase, 'regular', 'Scissors')
export const Search = withDefaultWeight(MagnifyingGlassBase, 'regular', 'Search')
...
export const Server = withDefaultWeight(HardDrivesBase, 'regular', 'Server')
export const Settings = withDefaultWeight(GearSixBase, 'regular', 'Settings')
...
export const Square = withDefaultWeight(SquareBase, 'regular', 'Square')
...
export const Trash2 = withDefaultWeight(TrashBase, 'regular', 'Trash2')
...
export const Wrench = withDefaultWeight(WrenchBase, 'regular', 'Wrench')
export const X = withDefaultWeight(XBase, 'regular', 'X')
