...
- Secure storage: `secure-storage.json` (`electron/secureStorage.ts`)
  ...
  - Stored API keys: `openRouterApiKey`, `perplexityApiKey`, `groqApiKey`, `alibabaApiKey`, `fireworksApiKey`, `deepseekApiKey`, `tavilyApiKey`, `brevoApiKey`
